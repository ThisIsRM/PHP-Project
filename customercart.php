...
<section class="cart">
    <div class="container">
        <h2 class="text-center b"><b><p style="font-family:Edwardian Script ITC">Add item to Cart</p></b></h2>
        <center> <img src="images/cart2.gif" alt="Cart Logo" class="img-responsive" style="width:120px;height:130px;"> </center>
        ...
        <form action="" method="POST" class="order">
            <fieldset>
                ...
                <div class="food-menu-desc">
                    ...
                    <p class="food-price">Rs.<?php echo $discount_amount; ?></p>
