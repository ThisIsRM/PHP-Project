...
<section class="food-menu">
    <div class="container">
        <h2 class="text-center b" style="font-family:Harrington">Shopping Cart</h2>
        <center> <img src="images/cart1.gif" alt="cart Logo" class="img-responsive" style="width:120px;height:130px;"> </center>
        <style>
            table,
            td,
            th {
