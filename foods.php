...
<center>
    <img src="images/cakes1.gif" alt="Cake Logo" class="img-responsive" style="width:120px;height:130px;"> 
<img src="images/cakes1.gif" alt="Cake Logo" class="img-responsive" style="width:120px;height:130px;"> 
<img src="images/cakes1.gif" alt="Cake Logo" class="img-responsive" style="width:120px;height:130px;"> 
</center>
...
<section class="food-menu flex-container">
    <div class="container">
        <h2 class="text-center b"><b><p style="font-family:Edwardian Script ITC">Bakery Items</p></b></h2>
        ...
        ?>
                ...
                <div class="food-menu-box">
                    ...
                    <div class="food-menu-desc">
                        <h3 style="font-family:Harrington"><?php echo $title; ?></h3>
                        <b><p class="food-price" style="font-family:Harrington">
                            <?php
